...
urlpatterns = [
    ...
    path('<pk>/module/', views.CourseModuleUpdateView.as_view(), name='course_module_list'),
 ...
 name='module_content_update'),
    path('<pk>/module/', views.CourseModuleUpdateView.as_view(), name='course_module_delete'),
    ...
    # path('subject/<pk>/edit/', views.SubjectUpdateView.as_view(), name='subject_edit'),
